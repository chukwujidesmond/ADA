...
class AccessibilityProfiles {
    ...
    static init() {
        ...
        const profiles = document.querySelectorAll( '#mdp-webcop-accessibility-profiles-box .mdp-webcop-accessibility-profile-item' );
    ...
    static toggleProfile( e ) {
        ...
        let profileItem = this.closest( '.mdp-webcop-accessibility-profile-item' );
        ...
        if ( ! profileItem.classList.contains( 'mdp-active' ) ) {
            ...
            let prevProfile = document.querySelector( '#mdp-webcop-accessibility-profiles-box .mdp-webcop-accessibility-profile-item.mdp-active' );
            ...
            let profileName = profileItem.id.replace( 'mdp-webcop-accessibility-profile-', '' );
    ...
    static profileEpilepsy( enable ) {
        ...
        let fClass = 'mdp-webcop-profile-epilepsy';
        ...
        if ( enable ) {
            ...
            let lowSaturation = document.querySelector( '#mdp-webcop-action-low-saturation:not(.mdp-active)' );
            if ( lowSaturation ) { lowSaturation.click(); }

            let stopAnimations = document.querySelector( '#mdp-webcop-action-stop-animations:not(.mdp-active)' );
        ...
        /** Disable Epilepsy Profile. */
            ...
            let lowSaturation = document.querySelector( '#mdp-webcop-action-low-saturation.mdp-active' );
            if ( lowSaturation ) { lowSaturation.click(); }

            let stopAnimations = document.querySelector( '#mdp-webcop-action-stop-animations.mdp-active' );
            if ( stopAnimations ) { stopAnimations.click(); }
    ...
    static profileVisuallyImpaired( enable ) {
        ...
        let fClass = 'mdp-webcop-profile-visually-impaired';
        ...
        if ( enable ) {
            ...
            let readableFont = document.querySelector( '#mdp-webcop-action-readable-font:not(.mdp-active)' );
            if ( readableFont ) { readableFont.click(); }

            let highSaturation = document.querySelector( '#mdp-webcop-action-high-saturation:not(.mdp-active)' );
        ...
        /** Disable Visually Impaired Profile. */
            ...
            let readableFont = document.querySelector( '#mdp-webcop-action-readable-font.mdp-active' );
            if ( readableFont ) { readableFont.click(); }

            let highSaturation = document.querySelector( '#mdp-webcop-action-high-saturation.mdp-active' );
            if ( highSaturation ) { highSaturation.click(); }
    ...
    static profileCognitiveDisability( enable ) {
        ...
        let fClass = 'mdp-webcop-profile-cognitive-disability';
        ...
        if ( enable ) {
            ...
            let highlightTitles = document.querySelector( '#mdp-webcop-action-highlight-titles:not(.mdp-active)' );
            if ( highlightTitles ) { highlightTitles.click(); }

            let highlightLinks = document.querySelector( '#mdp-webcop-action-highlight-links:not(.mdp-active)' );
        ...
        /** Disable Cognitive Disability Profile. */
            ...
            let highlightTitles = document.querySelector( '#mdp-webcop-action-highlight-titles.mdp-active' );
            if ( highlightTitles ) { highlightTitles.click(); }

            let highlightLinks = document.querySelector( '#mdp-webcop-action-highlight-links.mdp-active' );
            if ( highlightLinks ) { highlightLinks.click(); }
    ...
    static profileAdhdFriendly( enable ) {
        ...
        let fClass = 'mdp-webcop-profile-adhd-friendly';
        ...
        if ( enable ) {
            ...
            let readingMask = document.querySelector( '#mdp-webcop-action-reading-mask:not(.mdp-active)' );
        ...
        /** Disable ADHD Friendly Profile. */
            ...
            let readingMask = document.querySelector( '#mdp-webcop-action-reading-mask.mdp-active' );
            if ( readingMask ) { readingMask.click(); }
    ...
    static profileBlindUsers( enable ) {
        ...
        let fClass = 'mdp-webcop-profile-blind-users';
        ...
        if ( enable ) {
            ...
            let virtualKeyboard = document.querySelector( '#mdp-webcop-action-virtual-keyboard:not(.mdp-active)' );
            if ( virtualKeyboard ) { virtualKeyboard.click(); }

            let textToSpeech = document.querySelector( '#mdp-webcop-action-text-to-speech:not(.mdp-active)' );
            if ( textToSpeech ) { textToSpeech.click(); }

            let keyboardNavigation = document.querySelector( '#mdp-webcop-action-keyboard-navigation:not(.mdp-active)' );
        ...
        /** Disable Blind Users Profile. */
            ...
            let virtualKeyboard = document.querySelector( '#mdp-webcop-action-virtual-keyboard.mdp-active' );
            if ( virtualKeyboard ) { virtualKeyboard.click(); }

            let textToSpeech = document.querySelector( '#mdp-webcop-action-text-to-speech.mdp-active' );
            if ( textToSpeech ) { textToSpeech.click(); }

            let keyboardNavigation = document.querySelector( '#mdp-webcop-action-keyboard-navigation.mdp-active' );
            if ( keyboardNavigation ) { keyboardNavigation.click(); }
    ...
    static isProfiles() {
        ...
        return !! (
            webcopOptions.profileEpilepsy ||
            webcopOptions.profileVisuallyImpaired ||
            webcopOptions.profileCognitiveDisability ||
            webcopOptions.profileAdhdFriendly ||
            webcopOptions.profileBlindUsers
        );
...
class ActionAccessibilityStatement {
    ...
    static init( options ) {
        ...
        if ( options.accessibilityStatement && [ 'iframe', 'html' ].includes( options.accessibilityStatementType ) ) {
            ...
            if ( null === document.getElementById( 'mdp-webcop-statement-btn' ) ) { return; }

            /** Listen for show statement button click. */
            let btn = document.getElementById( 'mdp-webcop-statement-btn' );
            btn.addEventListener( 'click', ActionAccessibilityStatement.show );

            let closeBtn = document.getElementById( 'mdp-webcop-close-statement-btn' );
    ...
    static show( e ) {
        ...
        let box = document.getElementById( 'mdp-webcop-accessibility-statement-box' );
...
class ActionAlignCenter {
    ...
    static init() {
        ...
        let alignCenter = document.querySelector( '#mdp-webcop-action-align-center' );
        alignCenter.addEventListener( 'WebcopToggleBoxChanged', ActionAlignCenter.alignCenter );
    ...
    static alignCenter( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-align-center' );
            return;
        ...
        document.body.classList.add( 'mdp-webcop-align-center' );

        /** Add CSS to header. */
        const alignCenterStyle = document.createElement( 'style' );
        alignCenterStyle.innerHTML = `
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-align-center,
                body.mdp-webcop-align-center h1,
                body.mdp-webcop-align-center h1 span,
                body.mdp-webcop-align-center h2,
                body.mdp-webcop-align-center h2 span,
                body.mdp-webcop-align-center h3,
                body.mdp-webcop-align-center h3 span,
                body.mdp-webcop-align-center h4,
                body.mdp-webcop-align-center h4 span,
                body.mdp-webcop-align-center h5,
                body.mdp-webcop-align-center h5 span,
                body.mdp-webcop-align-center h6,
                body.mdp-webcop-align-center h6 span,

                body.mdp-webcop-align-center p,
                body.mdp-webcop-align-center li,
                body.mdp-webcop-align-center label,
                body.mdp-webcop-align-center input,
                body.mdp-webcop-align-center select,
                body.mdp-webcop-align-center textarea,
                body.mdp-webcop-align-center legend,
                body.mdp-webcop-align-center code,
                body.mdp-webcop-align-center pre,
                body.mdp-webcop-align-center dd,
                body.mdp-webcop-align-center dt,
                body.mdp-webcop-align-center span,
                body.mdp-webcop-align-center blockquote {
    ...
    static disableOthers() {
        ...
        let left = document.getElementById( 'mdp-webcop-action-align-left' );
        ...
        let right = document.getElementById( 'mdp-webcop-action-align-right' );
...
class ActionAlignLeft {
    ...
    static init() {
        ...
        let alignLeft = document.querySelector( '#mdp-webcop-action-align-left' );
        alignLeft.addEventListener( 'WebcopToggleBoxChanged', ActionAlignLeft.alignLeft );
    ...
    static alignLeft( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-align-left' );
            return;
        ...
        /** Add class to body, to apply to align styles. */
        document.body.classList.add( 'mdp-webcop-align-left' );

        /** Add CSS to header. */
        const alignLeftStyle = document.createElement( 'style' );
        alignLeftStyle.innerHTML = `
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-align-left,
                body.mdp-webcop-align-left h1,
                body.mdp-webcop-align-left h1 span,
                body.mdp-webcop-align-left h2,
                body.mdp-webcop-align-left h2 span,
                body.mdp-webcop-align-left h3,
                body.mdp-webcop-align-left h3 span,
                body.mdp-webcop-align-left h4,
                body.mdp-webcop-align-left h4 span,
                body.mdp-webcop-align-left h5,
                body.mdp-webcop-align-left h5 span,
                body.mdp-webcop-align-left h6,
                body.mdp-webcop-align-left h6 span,

                body.mdp-webcop-align-left p,
                body.mdp-webcop-align-left li,
                body.mdp-webcop-align-left label,
                body.mdp-webcop-align-left input,
                body.mdp-webcop-align-left select,
                body.mdp-webcop-align-left textarea,
                body.mdp-webcop-align-left legend,
                body.mdp-webcop-align-left code,
                body.mdp-webcop-align-left pre,
                body.mdp-webcop-align-left dd,
                body.mdp-webcop-align-left dt,
                body.mdp-webcop-align-left span,
                body.mdp-webcop-align-left blockquote {
    ...
    static disableOthers() {
        ...
        let center = document.getElementById( 'mdp-webcop-action-align-center' );
...
class ActionAlignRight {
    ...
    static init() {
        ...
        let alignRight = document.querySelector( '#mdp-webcop-action-align-right' );
        alignRight.addEventListener( 'WebcopToggleBoxChanged', ActionAlignRight.alignRight );
    ...
    static alignRight( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-align-right' );
            return;
        ...
        /** Add class to body, to apply to align styles. */
        document.body.classList.add( 'mdp-webcop-align-right' );

        /** Add CSS to header. */
        const alignRightStyle = document.createElement( 'style' );
        alignRightStyle.innerHTML = `
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-align-right,
                body.mdp-webcop-align-right h1,
                body.mdp-webcop-align-right h1 span,
                body.mdp-webcop-align-right h2,
                body.mdp-webcop-align-right h2 span,
                body.mdp-webcop-align-right h3,
                body.mdp-webcop-align-right h3 span,
                body.mdp-webcop-align-right h4,
                body.mdp-webcop-align-right h4 span,
                body.mdp-webcop-align-right h5,
                body.mdp-webcop-align-right h5 span,
                body.mdp-webcop-align-right h6,
                body.mdp-webcop-align-right h6 span,

                body.mdp-webcop-align-right p,
                body.mdp-webcop-align-right li,
                body.mdp-webcop-align-right label,
                body.mdp-webcop-align-right input,
                body.mdp-webcop-align-right select,
                body.mdp-webcop-align-right textarea,
                body.mdp-webcop-align-right legend,
                body.mdp-webcop-align-right code,
                body.mdp-webcop-align-right pre,
                body.mdp-webcop-align-right dd,
                body.mdp-webcop-align-right dt,
                body.mdp-webcop-align-right span,
                body.mdp-webcop-align-right blockquote {
...
class ActionBackgroundColors {
    ...
    static init() {
        ...
        let backgroundColors = document.querySelector( '#mdp-webcop-action-background-colors' );
        backgroundColors.addEventListener( 'WebcopPaletteChanged', ActionBackgroundColors.backgroundColors );
    ...
    static backgroundColors( e ) {
        ...
        if ( null === color ) {
            ...
            document.body.classList.remove( 'mdp-webcop-background-colors' );
            return;

        }

        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-background-colors' );

        /** Add CSS to header. */
        const backgroundColorsStyle = document.createElement( 'style' );
        backgroundColorsStyle.innerHTML = `
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-background-colors,
                body.mdp-webcop-background-colors h1,
                body.mdp-webcop-background-colors h1 span,
                body.mdp-webcop-background-colors h2,
                body.mdp-webcop-background-colors h2 span,
                body.mdp-webcop-background-colors h3,
                body.mdp-webcop-background-colors h3 span,
                body.mdp-webcop-background-colors h4,
                body.mdp-webcop-background-colors h4 span,
                body.mdp-webcop-background-colors h5,
                body.mdp-webcop-background-colors h5 span,
                body.mdp-webcop-background-colors h6,
                body.mdp-webcop-background-colors h6 span,

                body.mdp-webcop-background-colors p,
                body.mdp-webcop-background-colors li,
                body.mdp-webcop-background-colors label,
                body.mdp-webcop-background-colors input,
                body.mdp-webcop-background-colors select,
                body.mdp-webcop-background-colors textarea,
                body.mdp-webcop-background-colors legend,
                body.mdp-webcop-background-colors code,
                body.mdp-webcop-background-colors pre,
                body.mdp-webcop-background-colors dd,
                body.mdp-webcop-background-colors dt,
                body.mdp-webcop-background-colors span,
                body.mdp-webcop-background-colors blockquote {
...
class ActionBigBlackCursor {
    ...
    static init() {
        ...
        let bigBlackCursor = document.querySelector( '#mdp-webcop-action-big-black-cursor' );

        bigBlackCursor.addEventListener( 'WebcopToggleBoxChanged', ActionBigBlackCursor.bigBlackCursor );
    ...
    static bigBlackCursor( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-big-black-cursor' );
            return;
        ...
        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-big-black-cursor' );
        ...
        bigBlackCursorStyle.innerHTML = `
                ...
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-big-black-cursor,
                body.mdp-webcop-big-black-cursor * {
                    /*noinspection CssUnknownTarget*/
                    cursor: url("${ webcopOptions.path }img/cursor/black-cursor.svg"), default !important
                }
                
                body.mdp-webcop-big-black-cursor * input, 
                body.mdp-webcop-big-black-cursor * textarea, 
                body.mdp-webcop-big-black-cursor * select, 
                body.mdp-webcop-big-black-cursor * a, 
                body.mdp-webcop-big-black-cursor * button, 
                body.mdp-webcop-big-black-cursor * [role=button] {
                    /*noinspection CssUnknownTarget*/
                    cursor: url("${ webcopOptions.path }img/cursor/black-pointer.svg"), default !important;
                }
    ...
    static disableWhite() {
        ...
        /** Disable Big White Cursor if it's enabled. */
        let bigWhiteCursorBtn = document.getElementById( 'mdp-webcop-action-big-white-cursor' );
...
class ActionBigWhiteCursor {
    ...
    static init() {
        ...
        let bigWhiteCursor = document.querySelector( '#mdp-webcop-action-big-white-cursor' );
        bigWhiteCursor.addEventListener( 'WebcopToggleBoxChanged', ActionBigWhiteCursor.bigWhiteCursor );
    ...
    static bigWhiteCursor( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-big-white-cursor' );
            return;
        ...
        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-big-white-cursor' );
        ...
        bigWhiteCursorStyle.innerHTML = `
                ...
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-big-white-cursor,
                body.mdp-webcop-big-white-cursor * {
                    /*noinspection CssUnknownTarget*/
                    cursor: url("${ webcopOptions.path }img/cursor/white-cursor.svg"), default !important
                }
                
                body.mdp-webcop-big-white-cursor * input, 
                body.mdp-webcop-big-white-cursor * textarea, 
                body.mdp-webcop-big-white-cursor * select, 
                body.mdp-webcop-big-white-cursor * a, 
                body.mdp-webcop-big-white-cursor * button, 
                body.mdp-webcop-big-white-cursor * [role=button] {
                    /*noinspection CssUnknownTarget*/
                    cursor: url("${ webcopOptions.path }img/cursor/white-pointer.svg"), default !important;
                }
    ...
    static disableBlack() {
        ...
        let bigBlackCursorBtn = document.getElementById( 'mdp-webcop-action-big-black-cursor' );
...
class ActionContentScaling {
    ...
    static init() {
        ...
        let contentScaling = document.querySelector( '#mdp-webcop-action-content-scaling .mdp-webcop-value' );

        contentScaling.addEventListener( 'WebcopInputSpinnerChanged', this.scaleContent );
    ...
    static setFirefoxProperty( scale, selector, CSSProperty, unit ) {
        ...
        camelProperty = 'webcop' + camelProperty;
...
class ActionDarkContrast {
    ...
    static init() {
        ...
        let darkContrast = document.querySelector( '#mdp-webcop-action-dark-contrast' );
        darkContrast.addEventListener( 'WebcopToggleBoxChanged', ActionDarkContrast.darkContrast );
    ...
    static darkContrast( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-dark-contrast' );
            return;
        ...
        /** Add class to body, to apply to align styles. */
        document.body.classList.add( 'mdp-webcop-dark-contrast' );
...
class ActionDyslexiaFriendly {
    ...
    static init() {
        ...
        let dyslexiaFriendly = document.querySelector( '#mdp-webcop-action-dyslexia-font' );
        dyslexiaFriendly.addEventListener( 'WebcopToggleBoxChanged', ActionDyslexiaFriendly.dyslexiaFriendly );
    ...
    static dyslexiaFriendly( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-dyslexia-font' );
            return;
        ...
        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-dyslexia-font' );
        ...
        dyslexiaFriendlyStyle.innerHTML = `
                ...
                @font-face {
                    ...
                    src: url("${ webcopOptions.path }font/OpenDyslexic-Italic.eot");
                    src: local("OpenDyslexic Italic"), local("OpenDyslexic-Italic"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Italic.eot?#iefix") format("embedded-opentype"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Italic.woff2") format("woff2"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Italic.woff") format("woff"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Italic.ttf") format("truetype"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Italic.svg#OpenDyslexic-Italic") format("svg");
                    font-weight: normal;
                    font-style: italic;
                    font-display: swap; 
                }
                ...
                @font-face {
                    font-family: 'OpenDyslexic';
                    src: url("${ webcopOptions.path }font/OpenDyslexic-BoldItalic.eot");
                    src: local("OpenDyslexic Bold Italic"), local("OpenDyslexic-BoldItalic"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-BoldItalic.eot?#iefix") format("embedded-opentype"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-BoldItalic.woff2") format("woff2"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-BoldItalic.woff") format("woff"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-BoldItalic.ttf") format("truetype"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-BoldItalic.svg#OpenDyslexic-BoldItalic") format("svg");
                    font-weight: bold;
                    font-style: italic;
                    font-display: swap; 
                }
                ...
                @font-face {
                    font-family: 'OpenDyslexic';
                    src: url("${ webcopOptions.path }font/OpenDyslexic-Bold.eot");
                    src: local("OpenDyslexic Bold"), local("OpenDyslexic-Bold"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Bold.eot?#iefix") format("embedded-opentype"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Bold.woff2") format("woff2"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Bold.woff") format("woff"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Bold.ttf") format("truetype"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Bold.svg#OpenDyslexic-Bold") format("svg");
                    font-weight: bold;
                    font-style: normal;
                    font-display: swap; 
                }
                ...
                @font-face {
                    font-family: 'OpenDyslexic';
                    src: url("${ webcopOptions.path }font/OpenDyslexic-Regular.eot");
                    src: local("OpenDyslexic Regular"), local("OpenDyslexic-Regular"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Regular.eot?#iefix") format("embedded-opentype"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Regular.woff2") format("woff2"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Regular.woff") format("woff"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Regular.ttf") format("truetype"), 
                         url("${ webcopOptions.path }font/OpenDyslexic-Regular.svg#OpenDyslexic-Regular") format("svg");
                    font-weight: normal;
                    font-style: normal;
                    font-display: swap; 
                }
                ...
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-dyslexia-font,
                body.mdp-webcop-dyslexia-font h1,
                body.mdp-webcop-dyslexia-font h1 span,
                body.mdp-webcop-dyslexia-font h2,
                body.mdp-webcop-dyslexia-font h2 span,
                body.mdp-webcop-dyslexia-font h3,
                body.mdp-webcop-dyslexia-font h3 span,
                body.mdp-webcop-dyslexia-font h4,
                body.mdp-webcop-dyslexia-font h4 span,
                body.mdp-webcop-dyslexia-font h5,
                body.mdp-webcop-dyslexia-font h5 span,
                body.mdp-webcop-dyslexia-font h6,
                body.mdp-webcop-dyslexia-font h6 span,

                body.mdp-webcop-dyslexia-font a,
                body.mdp-webcop-dyslexia-font p,
                body.mdp-webcop-dyslexia-font li a,
                body.mdp-webcop-dyslexia-font label,
                body.mdp-webcop-dyslexia-font input,
                body.mdp-webcop-dyslexia-font select,
                body.mdp-webcop-dyslexia-font textarea,
                body.mdp-webcop-dyslexia-font legend,
                body.mdp-webcop-dyslexia-font code,
                body.mdp-webcop-dyslexia-font pre,
                body.mdp-webcop-dyslexia-font dd,
                body.mdp-webcop-dyslexia-font dt,
                body.mdp-webcop-dyslexia-font span,
                body.mdp-webcop-dyslexia-font blockquote {
    ...
    static disableOthers() {
        ...
        let readable = document.getElementById( 'mdp-webcop-action-readable-font' );
...
class ActionFontSizing {
    ...
    static init() {
        ...
        let fontSizing = document.querySelector( '#mdp-webcop-action-font-sizing .mdp-webcop-value' );
        fontSizing.addEventListener( 'WebcopInputSpinnerChanged', ActionFontSizing.fontSizing );
    ...
    static fontSizing( e ) {
        ...
        if ( 0 === scale ) {
            document.body.classList.remove( 'mdp-webcop-font-sizing' );
            return;
        }

        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-font-sizing' );
...
class ActionHideAccessibility {
    ...
    static init() {
        ...
        let btn = document.getElementById( 'mdp-webcop-hide-btn' );
    ...
    static hide( e ) {
        ...
        if ( window.confirm( i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t( 'hide-forever-message' ) ) ) {
            ...
            ActionHideAccessibility.writeCookie( 'mdp-webcop-hide', '1', 365 );
...
class ActionHideImages {
    ...
    static init() {
        ...
        let hideImages = document.querySelector( '#mdp-webcop-action-hide-images' );
        hideImages.addEventListener( 'WebcopToggleBoxChanged', ActionHideImages.hideImages );
    ...
    static hideImages( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-hide-images' );
            return;

        }

        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-hide-images' );

        /** Add CSS to header. */
        const hideImagesStyle = document.createElement( 'style' );
        hideImagesStyle.innerHTML = `
                body.mdp-webcop-hide-images img,
                body.mdp-webcop-hide-images video {
                    opacity: 0 !important;
                    visibility: hidden !important
                }

                body.mdp-webcop-hide-images * {
...
class ActionHighContrast {
    ...
    static init() {
        ...
        let highContrast = document.querySelector( '#mdp-webcop-action-high-contrast' );
        highContrast.addEventListener( 'WebcopToggleBoxChanged', ActionHighContrast.highContrast );
    ...
    static highContrast( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-high-contrast' );
            return;
        ...
        /** Add class to body, to apply to align styles. */
        document.body.classList.add( 'mdp-webcop-high-contrast' );
...
class ActionHighSaturation {
    ...
    static init() {
        ...
        let highSaturation = document.querySelector( '#mdp-webcop-action-high-saturation' );
        highSaturation.addEventListener( 'WebcopToggleBoxChanged', ActionHighSaturation.highSaturation );
    ...
    static highSaturation( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-high-saturation' );
            return;
        ...
        /** Add class to body, to apply to align styles. */
        document.body.classList.add( 'mdp-webcop-high-saturation' );
...
class ActionHighlightFocus {
    ...
    static init() {
        ...
        let highlightFocus = document.querySelector( '#mdp-webcop-action-highlight-focus' );
        highlightFocus.addEventListener( 'WebcopToggleBoxChanged', ActionHighlightFocus.highlightFocus );
    ...
    static highlightFocus( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-highlight-focus' );
            return;

        }

        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-highlight-focus' );
...
class ActionHighlightHover {
    ...
    static init() {
        ...
        let highlightHover = document.querySelector( '#mdp-webcop-action-highlight-hover' );
        highlightHover.addEventListener( 'WebcopToggleBoxChanged', ActionHighlightHover.highlightHover );
    ...
    static highlightHover( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-highlight-hover' );
            return;

        }

        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-highlight-hover' );
...
class ActionHighlightLinks {
    ...
    static init() {
        ...
        let highlightLinks = document.querySelector( '#mdp-webcop-action-highlight-links' );
        highlightLinks.addEventListener( 'WebcopToggleBoxChanged', ActionHighlightLinks.highlightLinks );
    ...
    static highlightLinks( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-highlight-links' );
            return;

        }

        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-highlight-links' );
...
class ActionHighlightTitles {
    ...
    static init() {
        ...
        let highlightTitles = document.querySelector( '#mdp-webcop-action-highlight-titles' );
        highlightTitles.addEventListener( 'WebcopToggleBoxChanged', ActionHighlightTitles.highlightTitles );
    ...
    static highlightTitles( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-highlight-titles' );
            return;

        }

        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-highlight-titles' );
...
class ActionKeyboardNavigation {
    ...
    static init() {
        ...
        let keyboardNavigation = document.querySelector( '#mdp-webcop-action-keyboard-navigation' );
        keyboardNavigation.addEventListener( 'WebcopToggleBoxChanged', ActionKeyboardNavigation.keyboardNavigation );
    ...
    static keyboardNavigation( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-keyboard-navigation' );
        ...
        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-keyboard-navigation' );
    ...
    static makeFocusable() {
        ...
        document.querySelectorAll(
            ...
            if ( element.tabIndex < 0 ) {
                element.dataset.webcopOriginalTabIndex = element.tabIndex;
                element.tabIndex = 0;
            }
    ...
    static restoreOriginalTabIndex() {
        ...
        document.querySelectorAll(
            ...
            if ( null != element.dataset.webcopOriginalTabIndex ) {
                element.tabIndex = element.dataset.webcopOriginalTabIndex;
                delete element.dataset.webcopOriginalTabIndex;
            }
...
class ActionLetterSpacing {
    ...
    static init() {
        ...
        let letterSpacing = document.querySelector( '#mdp-webcop-action-letter-spacing .mdp-webcop-value' );
        letterSpacing.addEventListener( 'WebcopInputSpinnerChanged', this.letterSpacing );
    ...
    static letterSpacing( e ) {
        ...
        /** Remove class from body to reset font size to default values. */
        if ( 0 === scale ) {
            document.body.classList.remove( 'mdp-webcop-letter-spacing' );
            return;
        }

        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-letter-spacing' );
        ...
        letterSpacingStyle.innerHTML = `
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-letter-spacing,
                body.mdp-webcop-letter-spacing h1,
                body.mdp-webcop-letter-spacing h1 span,
                body.mdp-webcop-letter-spacing h2,
                body.mdp-webcop-letter-spacing h2 span,
                body.mdp-webcop-letter-spacing h3,
                body.mdp-webcop-letter-spacing h3 span,
                body.mdp-webcop-letter-spacing h4,
                body.mdp-webcop-letter-spacing h4 span,
                body.mdp-webcop-letter-spacing h5,
                body.mdp-webcop-letter-spacing h5 span,
                body.mdp-webcop-letter-spacing h6,
                body.mdp-webcop-letter-spacing h6 span,
                
                body.mdp-webcop-letter-spacing p,
                body.mdp-webcop-letter-spacing li,
                body.mdp-webcop-letter-spacing label,
                body.mdp-webcop-letter-spacing input,
                body.mdp-webcop-letter-spacing select,
                body.mdp-webcop-letter-spacing textarea,
                body.mdp-webcop-letter-spacing legend,
                body.mdp-webcop-letter-spacing code,
                body.mdp-webcop-letter-spacing pre,
                body.mdp-webcop-letter-spacing dd,
                body.mdp-webcop-letter-spacing dt,
                body.mdp-webcop-letter-spacing span,
                body.mdp-webcop-letter-spacing blockquote {
...
class ActionLightContrast {
    ...
    static init() {
        ...
        let lightContrast = document.querySelector( '#mdp-webcop-action-light-contrast' );
        lightContrast.addEventListener( 'WebcopToggleBoxChanged', ActionLightContrast.lightContrast );
    ...
    static lightContrast( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-light-contrast' );
            return;
        ...
        /** Add class to body, to apply to align styles. */
        document.body.classList.add( 'mdp-webcop-light-contrast' );
...
class ActionLineHeight {
    ...
    static init() {
        ...
        let lineHeight = document.querySelector( '#mdp-webcop-action-line-height .mdp-webcop-value' );
        lineHeight.addEventListener( 'WebcopInputSpinnerChanged', this.lineHeight );
    ...
    static lineHeight( e ) {
        ...
        if ( 0 === scale ) {
            document.body.classList.remove( 'mdp-webcop-line-height' );
            return;
        }

        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-line-height' );
...
class ActionLowSaturation {
    ...
    static init() {
        ...
        let lowSaturation = document.querySelector( '#mdp-webcop-action-low-saturation' );
        lowSaturation.addEventListener( 'WebcopToggleBoxChanged', ActionLowSaturation.lowSaturation );
    ...
    static lowSaturation( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-low-saturation' );
            return;
        ...
        /** Add class to body, to apply to align styles. */
        document.body.classList.add( 'mdp-webcop-low-saturation' );
...
class ActionMonochrome {
    ...
    static init() {
        ...
        let monochrome = document.querySelector( '#mdp-webcop-action-monochrome' );
        monochrome.addEventListener( 'WebcopToggleBoxChanged', ActionMonochrome.monochrome );
    ...
    static monochrome( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-monochrome' );
            return;
        ...
        /** Add class to body, to apply to align styles. */
        document.body.classList.add( 'mdp-webcop-monochrome' );
...
class ActionMuteSounds {
    ...
    static init() {
        ...
        let muteSounds = document.querySelector( '#mdp-webcop-action-mute-sounds' );
        muteSounds.addEventListener( 'WebcopToggleBoxChanged', ActionMuteSounds.muteSounds );
    ...
    static muteSounds( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.documentElement.classList.remove( 'mdp-webcop-mute-sounds' );
        ...
        /** Add class to body as flag. */
        document.documentElement.classList.add( 'mdp-webcop-mute-sounds' );
...
class ActionReadableFont {
    ...
    static init() {
        ...
        let readableFont = document.querySelector( '#mdp-webcop-action-readable-font' );
        readableFont.addEventListener( 'WebcopToggleBoxChanged', ActionReadableFont.readableFont );
    ...
    static readableFont( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-readable-font' );
            return;
        ...
        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-readable-font' );

        /** Add CSS to header. */
        //language=CSS
        readableFontStyle.innerHTML = `
                /*noinspection CssUnusedSymbol*/
                body.mdp-webcop-readable-font *:not(i){
    ...
    static disableOthers() {
        ...
        let dyslexia = document.getElementById( 'mdp-webcop-action-dyslexia-font' );
...
class ActionReadingGuide {
    ...
    static init() {
        ...
        let readingGuide = document.querySelector( '#mdp-webcop-action-reading-guide' );
        readingGuide.addEventListener( 'WebcopToggleBoxChanged', ActionReadingGuide.readingGuide );
    ...
    static createReadingGuide() {
        ...
        if ( document.querySelectorAll( '.mdp-webcop-reading-guide-element' ).length ) { return; }
        ...
        readingGuideEl.classList.add( 'mdp-webcop-reading-guide-element' );
    ...
    static removeReadingGuide() {
        ...
        document.body.classList.remove( 'mdp-webcop-reading-guide' );
    ...
    static addCSS() {
        ...
        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-reading-guide' );
...
class ActionReadingMask {
    ...
    static init() {
        ...
        let readingMask = document.querySelector( '#mdp-webcop-action-reading-mask' );
        readingMask.addEventListener( 'WebcopToggleBoxChanged', ActionReadingMask.readingMask );
    ...
    static createReadingMask() {
        ...
        if ( document.querySelectorAll( '.mdp-webcop-reading-mask-top' ).length ) { return; }

        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-reading-mask' );

        /** Create reading mask top element. */
        readingMaskTop = document.createElement( 'div' );
        readingMaskTop.classList.add( 'mdp-webcop-reading-mask-top' );
        document.body.appendChild( readingMaskTop );

        /** Create reading mask bottom element. */
        readingMaskBottom = document.createElement( 'div' );
        readingMaskBottom.classList.add( 'mdp-webcop-reading-mask-bottom' );
    ...
    static moveReadingMask( e ) {
        ...
        let newPosY = e.clientY;
        let delta = Math.round( webcopOptions.readingMaskHeight / 2 );
    ...
    static removeReadingMask() {
        ...
        /** Remove flag-class */
        document.body.classList.remove( 'mdp-webcop-reading-mask' );
...
class ActionResetSettings {
    ...
    static init() {
        ...
        let btn = document.getElementById( 'mdp-webcop-reset-btn' );
    ...
    static reset( e ) {
        ...
        /** Remove all items which starts with 'mdpWebcop' */
        for ( const key in keys ) {

            if ( keys[key].toString().startsWith( 'mdpWebcop' ) ) {
...
class ActionStopAnimations {
    ...
    static init() {
        ...
        let stopAnimations = document.querySelector( '#mdp-webcop-action-stop-animations' );
        stopAnimations.addEventListener( 'WebcopToggleBoxChanged', ActionStopAnimations.stopAnimations );
    ...
    static stopAnimations( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-stop-animations' );
            ...
            document.querySelectorAll('video').forEach(vid => {
                ...
                if ( vid.paused === true ) {
                    ...
                    if ( vid.dataset.pausedByWebcop === 'true' ) {

                        vid.play();
                        vid.dataset.pausedByWebcop = 'false';
        ...
        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-stop-animations' );
        ...
        stopAnimationsStyle.innerHTML = `
                ...
                body.mdp-webcop-stop-animations *{
    ...
    static stopVideo() {
        ...
        document.querySelectorAll( 'video' ).forEach( vid => {
            ...
            if ( vid.paused === false ) {
                ...
                if ( vid.dataset.pausedByWebcop !== 'true' ) {
                    vid.pause();
                    vid.dataset.pausedByWebcop = 'true';
                }
    ...
    static stopYouTubeVideo() {
        ...
        document.querySelectorAll( 'iframe' ).forEach( iframe => {
            ...
            if ( iframe.dataset.pausedByWebcop === 'undefined' ) {

                iframe.dataset.pausedByWebcop = 'true';
...
class ActionTextColors {
    ...
    static init() {
        ...
        let textColors = document.querySelector( '#mdp-webcop-action-text-colors' );
        textColors.addEventListener( 'WebcopPaletteChanged', ActionTextColors.textColors );
    ...
    static textColors( e ) {
        ...
        if ( null === color ) {
            ...
            /** Add class to body, to apply styles. */
            document.body.classList.remove( 'mdp-webcop-text-colors' );
            return;

        }

        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-text-colors' );

        /** Add CSS to header. */
        const textColorsStyle = document.createElement( 'style' );
        textColorsStyle.innerHTML = `
                body.mdp-webcop-text-colors p,
                body.mdp-webcop-text-colors li,
                body.mdp-webcop-text-colors label,
                body.mdp-webcop-text-colors input,
                body.mdp-webcop-text-colors select,
                body.mdp-webcop-text-colors textarea,
                body.mdp-webcop-text-colors legend,
                body.mdp-webcop-text-colors code,
                body.mdp-webcop-text-colors pre,
                body.mdp-webcop-text-colors dd,
                body.mdp-webcop-text-colors dt,
                body.mdp-webcop-text-colors span,
                body.mdp-webcop-text-colors blockquote {
...
class ActionTextMagnifier {
    ...
    static init() {
        ...
        let textMagnifier = document.querySelector( '#mdp-webcop-action-text-magnifier' );
        textMagnifier.addEventListener( 'WebcopToggleBoxChanged', ActionTextMagnifier.textMagnifier );

        /** Set id for tooltip. */
        tooltip.id = 'mdp-webcop-text-magnifier-tooltip';
    ...
    static textMagnifier( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-text-magnifier' );
        ...
        /** Add class to body. */
        document.body.classList.add( 'mdp-webcop-text-magnifier' );
...
class ActionTextToSpeech {
    ...
    static utterance( text ) {
        ...
        // Set language
        if ( webcopOptions.ttsLang !== '' ) {

            utterThis.lang = webcopOptions.ttsLang;

        }

        // Set voice name
        if ( webcopOptions.ttsVoiceName !== '' ) {

            utterThis.lang = webcopOptions.ttsVoiceName;

        }

        utterThis.pitch = webcopOptions.ttsPitch;
        utterThis.rate = webcopOptions.ttsRate;
        utterThis.volume = webcopOptions.ttsVolume;
    ...
    static init() {
        ...
        if ( synth.getVoices().length > 0 ) {
            ...
            if ( document.querySelectorAll( '#mdp-webcop-action-text-to-speech' ).length < 1 ) { return }

            /** Listen for Text To Speech change. */
            let textToSpeech = document.querySelector( '#mdp-webcop-action-text-to-speech' );
            textToSpeech.addEventListener( 'WebcopToggleBoxChanged', ActionTextToSpeech.textToSpeech );
    ...
    static webAudioTouchUnlock() {
        ...
        if ( null !== mdp_webcop_context ) { return; }

        mdp_webcop_context = new AudioContext();
        mdp_webcop_context.resume();
    ...
    static textToSpeech( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-text-to-speech' );
            return;

        }

        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-text-to-speech' );

        /** Init Text to Speech */
        webcopTTS = new _TextToSpeechSelection__WEBPACK_IMPORTED_MODULE_0__.TextToSpeechSelection();
        webcopTTS.init();
    ...
    static voiceButton() {
        ...
        return ActionTextToSpeech.Button( webcopOptions.ttsPlayIcon, function ( ) {
    ...
    static onVoiceEnded() {
        ...
        const $tssWrapper = document.querySelector( '.mdp-webcop-tts.stop' );
    ...
    static setPlayIcon() {
        ...
        const el = document.querySelector('.mdp-webcop-tts .selection__icon');

        /** Create a new icon that will take the place of "el". */
        const newEl = document.createElement('div');
        newEl.innerHTML = webcopOptions.ttsPlayIcon;

        /** Replace el with newEL. */
        el.parentNode.replaceChild( newEl, el );

        /** Mark tooltip as 'Play' button. */
        const stop_popup = document.querySelector('.mdp-webcop-tts');
    ...
    static setStopIcon() {
        ...
        /** Select old icon that will be replaced. */
        const el = document.querySelector('.mdp-webcop-tts-button svg');

        if ( el ) {

            /** Create a new icon that will take the place of "el". */
            const newEl = document.createElement('div');
            newEl.innerHTML = webcopOptions.ttsStopIcon;

            /** Replace el with newEL. */
            el.parentNode.replaceChild(newEl, el);

            /** Mark tooltip as 'Stop' button. */
            const popup = document.querySelector('.mdp-webcop-tts');
            popup.classList.add( 'stop' );

            const stop_popup = document.querySelector('.mdp-webcop-tts.stop');
    ...
    static setTooltipPosition() {
        ...
        left = position.left + (position.width - webcopOptions.ttsIconSize * _icons.length) / 2;

        /** Set position for desktop **/
        if ( ! USER_IS_TOUCHING ) {

            top = position.top + DOCUMENT_SCROLL_TOP - webcopOptions.ttsIconSize - 10;

            /** Set position for mobile **/
        } else {

            top = position.bottom + DOCUMENT_SCROLL_TOP + webcopOptions.ttsIconSize + 10;
    ...
    static moveTooltip() {
        ...
        if ( !!document.querySelector('.mdp-webcop-tts') ) {

            ActionTextToSpeech.setTooltipPosition();
            let tooltip = document.querySelector('.mdp-webcop-tts');
            tooltip.style.top = ( top - webcopOptions.ttsIconSize / 2 ) + 'px';
            tooltip.style.left = ( left - webcopOptions.ttsIconSize / 2 ) + 'px';
    ...
    static drawTooltip() {
        ...
        const div = document.createElement('div');
        div.className = 'mdp-webcop-tts';
        // noinspection JSValidateTypes
        div.style =
            'top:' + ( top - webcopOptions.ttsIconSize / 2 ) + 'px;' +
            'left:' + ( left - webcopOptions.ttsIconSize / 2 ) + 'px;' +
            mobileTransform;

        div.appendChild( _icons.icons );

        const arrow = document.createElement( 'div' );
        arrow.classList.add( 'mdp-webcop-tts-arrow' )
        // noinspection JSValidateTypes
        arrow.style =
            'left:' + ( webcopOptions.ttsIconSize * _icons.length / 2 + 2 ) + 'px;';
    ...
    static attachEvents() {
        ...
        function hasTooltipDrawn() {
            return !!document.querySelector('.mdp-webcop-tts');
        }
            ...
            setTimeout( function mouseTimeout() {
                ...
                if ( hasTooltipDrawn() ) {
                    ...
                    if (hasSelection()) {
                        ...
                        if ( document.querySelector('.mdp-webcop-tts.stop') ) {
    ...
    static Button( icon, clickFn ) {
        ...
        btn.classList.add( 'mdp-webcop-tts-button' );
        btn.innerHTML = icon;
        btn.onclick = clickFn;

        if ( btn.id === 'mdp-webcop-tts-preloader' ) {
...
class ActionTitleColors {
    ...
    static init() {
        ...
        let titleColors = document.querySelector( '#mdp-webcop-action-title-colors' );
        titleColors.addEventListener( 'WebcopPaletteChanged', ActionTitleColors.titleColors );
    ...
    static titleColors( e ) {
        ...
        if ( null === color ) {
            ...
            /** Add class to body, to apply styles. */
            document.body.classList.remove( 'mdp-webcop-title-colors' );
            return;

        }

        /** Add class to body, to apply styles. */
        document.body.classList.add( 'mdp-webcop-title-colors' );

        /** Add CSS to header. */
        const titleColorsStyle = document.createElement( 'style' );
        titleColorsStyle.innerHTML = `
                body.mdp-webcop-title-colors h1,
                body.mdp-webcop-title-colors h1 *,
                body.mdp-webcop-title-colors h2,
                body.mdp-webcop-title-colors h2 *,
                body.mdp-webcop-title-colors h3,
                body.mdp-webcop-title-colors h3 *,
                body.mdp-webcop-title-colors h4,
                body.mdp-webcop-title-colors h4 *,
                body.mdp-webcop-title-colors h5,
                body.mdp-webcop-title-colors h5 *,
                body.mdp-webcop-title-colors h6,
                body.mdp-webcop-title-colors h6 * {
                    color: ${color} !important;
                }
            `;
...
class ActionUsefulLinks {
    ...
    static init() {
        ...
        let select = document.querySelector( '#mdp-webcop-useful-links' );
...
class ActionVirtualKeyboard {
    ...
    static init() {
        ...
        let virtualKeyboard = document.querySelector( '#mdp-webcop-action-virtual-keyboard' );
        virtualKeyboard.addEventListener( 'WebcopToggleBoxChanged', ActionVirtualKeyboard.virtualKeyboard );
        ...
        document.addEventListener( 'click', event => {
            ...
            if (
                ...
                null === event.target.closest( '#mdp-webcop-keyboard-box' ) &&
                /** And not input. */
                elType !== 'input' &&
                /** And not textarea. */
                elType !== 'textarea'
                ...
                /** Hide keyboard. */
                const keyboardBox = document.getElementById( 'mdp-webcop-keyboard-box' );
    ...
    static onInputFocus( event ) {
        ...
        if ( ! document.body.classList.contains( 'mdp-webcop-virtual-keyboard' ) ) { return; }
    ...
    static virtualKeyboard( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-active' ) ) {
            ...
            document.body.classList.remove( 'mdp-webcop-virtual-keyboard' );
        ...
        /** Add class to body as flag. */
        document.body.classList.add( 'mdp-webcop-virtual-keyboard' );

        /** Set selected layout for keyboard. */
        const KeyboardLayouts = new (simple_keyboard_layouts__WEBPACK_IMPORTED_MODULE_1___default())();
        const layout = KeyboardLayouts.get( webcopOptions.virtualKeyboardLayout );
        ...
        keyboard = new (simple_keyboard__WEBPACK_IMPORTED_MODULE_0___default())( {
            ...
            theme: 'mdp-webcop-simple-keyboard',
    ...
    static makeKeyboardDraggable() {
        ...
        let dragItem = document.getElementById( 'mdp-webcop-keyboard-box' );;
...
let defaultOptions = {
    ...
    'accessibilityStatementLink'    : './webcop/accessibility-statement.html',
...
function disableOthers( el ) {
    ...
    let activeBtn = document.querySelectorAll('#mdp-webcop-visually-pleasing-experience-box .mdp-webcop-toggle-box.mdp-active');
...
let focusSnail = (function() {
    ...
    function htmlFragment() {
		...
		<linearGradient id="focus-snail_gradient">\
			<stop id="focus-snail_start" offset="0%" stop-color="' + webcopOptions.highlightFocusColor + '" stop-opacity="0"/>\
			<stop id="focus-snail_middle" offset="80%" stop-color="' + webcopOptions.highlightFocusColor + '" stop-opacity="0.8"/>\
			<stop id="focus-snail_end" offset="100%" stop-color="' + webcopOptions.highlightFocusColor + '" stop-opacity="0"/>\
		</linearGradient>\
...
class HotKeyHelper {
    ...
    static init() {
        ...
        HotKeyHelper.focusElements( webcopOptions.hotKeyMenu, 'nav, [role="navigation"]' );

        /** Navigate to next/prev Heading. */
        HotKeyHelper.focusElements( webcopOptions.hotKeyHeadings, 'h1, h2, h3, h4, h5, h6, [role="heading"]' );

        /** Navigate to next/prev Form. */
        HotKeyHelper.focusElements( webcopOptions.hotKeyForms, 'form:not([disabled])' );

        /** Navigate to next/prev Button. */
        HotKeyHelper.focusElements( webcopOptions.hotKeyButtons, 'button:not([disabled]), [role="button"]:not([disabled])' );

        /** Navigate to next/prev Graphic. */
        HotKeyHelper.focusElements( webcopOptions.hotKeyGraphics, 'img, picture, svg' );
    ...
    static spacePressed( e ) {
        ...
        if ( activeElement.classList.contains( 'mdp-webcop-accessibility-profile-item' ) ) {

            /** Profile switchers. */
            e.preventDefault();
            activeElement.click();

        } else if ( activeElement.classList.contains( 'mdp-webcop-toggle-box' ) ) {

            /** Toggle boxes. */
            e.preventDefault();
            activeElement.click();

        } else if ( activeElement.classList.contains( 'mdp-webcop-color' ) ) {
    ...
    static OpenInterface() {
        ...
        (0,hotkeys_js__WEBPACK_IMPORTED_MODULE_2__["default"])( webcopOptions.hotKeyOpenInterface, function ( event ) {
    ...
    static focusElements( shortcutKey, selector ) {
        ...
        (0,hotkeys_js__WEBPACK_IMPORTED_MODULE_2__["default"])( shortcutKey + ',' + 'shift+' + shortcutKey, function ( event, handler ) {
            ...
            if ( ! document.body.classList.contains( 'mdp-webcop-keyboard-navigation' ) ) { return; }
...
class InputSpinner {
    ...
    static init() {
        ...
        /** Plus Button click. */
        let plusBtn = document.querySelectorAll( '.mdp-webcop-input-spinner-box .mdp-webcop-plus' );
        plusBtn.forEach( plusButton => plusButton.addEventListener( 'click', ( e ) => InputSpinner.step( e ) ) );

        /** Minus Button click. */
        let minusBtn = document.querySelectorAll( '.mdp-webcop-input-spinner-box .mdp-webcop-minus' );
    ...
    static step( e ) {
        ...
        let valueElement = e.target.closest( '.mdp-webcop-control' ).querySelector( '.mdp-webcop-value' );
        let value = parseInt( valueElement.dataset.value );

        let step = parseInt( e.target.closest( '.mdp-webcop-input-spinner-box' ).dataset.step );

        /** Increase/Decrease value by step. */
        if ( e.target.classList.contains( 'mdp-webcop-minus' ) ) {
            value = value - step;
        } else {
            value = value + step;
        }
        ...
        (0,_import_tools__WEBPACK_IMPORTED_MODULE_0__.setLocal)( e.target.closest( '.mdp-webcop-action-box').id, valueElement.dataset.value )

        /** Create the event. */
        const event = new CustomEvent( 'WebcopInputSpinnerChanged', {} );

        /** Fire custom event WebcopInputSpinnerChanged. */
    ...
    static loadSaved() {
        ...
        /** All spinner Boxes. */
        let spinnerBoxes = document.querySelectorAll( '.mdp-webcop-spinner-box' );
        ...
        spinnerBoxes.forEach( box => {
            ...
            let valueElement = box.querySelector( '.mdp-webcop-value' );
            valueElement.dataset.value = value.toString();
...
class OnlineDictionary {
    ...
    static init( options ) {
        ...
        if ( options.onlineDictionary ) {
            ...
            const $searchInput = document.getElementById('mdp-webcop-online-dictionary-search');
            ...
            const $clearResultsBtn = document.querySelector('#mdp-webcop-online-dictionary-search-close');
    ...
    static getLang() {
        ...
        if ( 'auto' === webcopOptions.language ) {
    ...
    static searchQuery( e ) {
        ...
        const $searchResultsUL = document.getElementById( 'mdp-webcop-online-dictionary-search-results' );
        const $clearResultsBtn = document.querySelector( '#mdp-webcop-online-dictionary-search-close' );
    ...
    static addResultToList( page ) {
        ...
        li.innerHTML = `
                    <h5 class="mdp-webcop-online-dictionary-title">${page.title}</h5>
                    <p class="mdp-webcop-online-dictionary-text">${wikiText}</p>
                    <a target="_blank" rel="nofollow" class="mdp-webcop-online-dictionary-link" href="https://${ this.getLang() }.wikipedia.org/wiki/${ page.title }">${ i18next__WEBPACK_IMPORTED_MODULE_1__["default"].t( 'lear-more-wikipedia' ) }</a>
                    `;
...
class PaletteBox {
    ...
    static init() {
        ...
        let palettes = document.querySelectorAll( '.mdp-webcop-palette-box' );
    ...
    static selectColor( e ) {
        ...
        if ( ! e.target.classList.contains( 'mdp-webcop-color' )  ) { return; }

        let currentPalette = e.target.closest( '.mdp-webcop-palette-box' );
        ...
        if ( e.target.classList.contains( 'mdp-active' ) ) {
            ...
            /** Fire WebcopPaletteChanged event. */
            PaletteBox.firePaletteChange( currentPalette, null );

            /** Save value to localStorage. */
            (0,_import_tools__WEBPACK_IMPORTED_MODULE_0__.setLocal)( e.target.closest( '.mdp-webcop-palette-box' ).id, null );

            /** Disable prev color and enable current. */
        } else {

            /** Deactivate another previous color. */
            let prevColor = currentPalette.querySelector( '.mdp-webcop-color.mdp-active' );
            if ( null !== prevColor ) {
            ...
            /** Save value to localStorage. */
            (0,_import_tools__WEBPACK_IMPORTED_MODULE_0__.setLocal)( e.target.closest( '.mdp-webcop-palette-box' ).id, e.target.dataset.color );
    ...
    static loadSaved() {
        ...
        /** All palette Boxes. */
        let paletteBoxes = document.querySelectorAll( '.mdp-webcop-palette-box' );
        ...
        paletteBoxes.forEach( box => {
            ...
            let colors = box.querySelectorAll( '.mdp-webcop-color' );
    ...
    /**
     * Create and trigger custom event WebcopPaletteChanged.
     **/
    static firePaletteChange( element, color ) {

        /** Create the event. */
        const event = new CustomEvent( 'WebcopPaletteChanged', { detail: { color: color } } );

        /** Fire custom event WebcopPaletteChanged. */
...
/** Popup modal window. */
const popup = document.getElementById( 'mdp-webcop-popup' );
...
class PopupHelper {
    ...
    static init() {
        ...
        /** Draggable popup */
        if ( webcopOptions.template === 'popup' && webcopOptions.popupDraggable ) {
        ...
        if ( webcopOptions.closeButton ) {

            document.getElementById( 'mdp-webcop-popup-close' ).addEventListener( 'click',  PopupHelper.closePopupCross );

        }

        /** Start to listen click event to find "data-webcop-trigger" click. */
        if ( webcopOptions.template === 'popup' ) {
    ...
    static closePopupCross( e ) {
        ...
        if ( webcopOptions.template === 'popup' ) {
            ...
            /** Close Popup */
            micromodal__WEBPACK_IMPORTED_MODULE_0__["default"].close( 'mdp-webcop-popup-box' );
    ...
    static toggleOffCanvas() {
        ...
        let bodyClassTarget = `mdp-webcop-${ webcopOptions.template }-is-open`;

        if ( webcopOptions.template === 'off-canvas' ) {

            bodyClassTarget += `-${ webcopOptions.sidebarAlign }`;
        ...
        if ( bodyClasses.contains( bodyClassTarget ) ) {
            ...
            // Overlay
            if ( webcopOptions.popupOverlay ) {

                document.querySelector('#mdp-webcop-overlay').remove();
            ...
            if ( webcopOptions.popupOverlay ) {
                ...
                $overlay.id = 'mdp-webcop-overlay';

                if ( webcopOptions.closeAnywhere ) {
    ...
    static togglePopup( e ) {
        ...
        if ( 'undefined' !== typeof e ) {
            ...
            button = ( null !== element.closest( '[data-webcop-trigger]' ) ) ?
                element.closest( '[data-webcop-trigger]' ) :
                element.closest( '.webcop-trigger' );
        ...
        /** Accessibility Popup. */
        let popup = document.getElementById( 'mdp-webcop-popup-box' );

        /** Toggle popup state. */
        if ( ! popup.classList.contains( 'mdp-is-open' ) ) {

            /** Show Popup. */
            micromodal__WEBPACK_IMPORTED_MODULE_0__["default"].show( 'mdp-webcop-popup-box', {
                onClose: () => { PopupHelper.onClosePopup(); },
                openClass: 'mdp-is-open',
                disableScroll: ! webcopOptions.popupScroll,
                disableFocus: false,
            } );
    ...
    static holdTriggerButtons() {
        ...
        document.querySelectorAll( '[data-webcop-trigger]' ).forEach( el  => {
    ...
    static releaseTriggerButtons() {
        ...
        let statementBox = document.getElementById( 'mdp-webcop-accessibility-statement-box' );
    ...
    static draggablePopup() {
        ...
        let dragZoneElement = document.getElementById( 'mdp-webcop-popup-header' );
...
class ToggleBox {
    ...
    static init() {
        ...
        /** Toggle Button click. */
        let toggleBoxes = document.querySelectorAll( '.mdp-webcop-toggle-box' );
    ...
    static toggle( e ) {
        ...
        /** All Toggle Boxes. */
        let toggleBox = e.target.closest( '.mdp-webcop-toggle-box' );
        ...
        /** Create the event. */
        const event = new CustomEvent( 'WebcopToggleBoxChanged', {} );

        /** Fire custom event WebcopToggleBoxChanged. */
...
class Button {
    ...
    $commentStart = document.createComment('Start Webcop Button');
    $commentEnd = document.createComment('End Webcop Button');
    ...
    $buttonBox( options ) {
        ...
        $buttonBox.classList.add( 'mdp-webcop-trigger-button-box' );
    ...
    $button( options ) {
        ...
        $button.id = 'mdp-webcop-trigger-button';
        ...
        $button.setAttribute( 'data-webcop-trigger','' );
        ...
        if ( options.buttonIcon !== '' ) {
            ...
            $icon.classList.add('mdp-webcop-trigger-button-icon');
        ...
        if ( options.buttonCaption !== '' ) {
            ...
            $caption.classList.add( 'mdp-webcop-trigger-button-caption' );
...
class Control {
    ...
    static $inputSpinner( key, title, label, step = 5 ) {
        ...
        $actionBox.id = `mdp-webcop-action-${ key }`;
        $actionBox.className = 'mdp-webcop-action-box mdp-webcop-spinner-box';

        $actionBox.innerHTML = `
        <div class="mdp-webcop-action-box-content">
            <span class="mdp-webcop-title">${ title }</span>
        </div>`;

        $actionBox.innerHTML += `
        <div class="mdp-webcop-input-spinner-box" data-step="${ step }">
            <div class="mdp-webcop-control">
                <button class="mdp-webcop-plus"
                        role="button"
                        tabindex="0"
                        aria-label="${ i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t( 'increase' ) } ${ label }" ></button>
                <div class="mdp-webcop-value" data-value="0">${ i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t( 'default' ) }</div>
                <button class="mdp-webcop-minus"
                        role="button"
                        tabindex="0"
    ...
    static $toggle( key, hide = false ) {
        ...
        const $actionBox = document.createElement( 'div' );
        $actionBox.id = `mdp-webcop-action-${ key }`;
        $actionBox.className = 'mdp-webcop-action-box mdp-webcop-toggle-box';
        hide ? $actionBox.classList.add( 'mdp-hidden' ) : '';
        $actionBox.tabIndex = 0;

        $actionBox.innerHTML = `
        <div class="mdp-webcop-action-box-content">
            <span class="mdp-webcop-icon"></span>
            <span class="mdp-webcop-title">${ i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t( key ) }</span>
        </div>
        `;
    ...
    static $palette( key ) {
        ...
        const colors = webcopOptions.palette;

        const $actionBox = document.createElement( 'div' );
        $actionBox.id = `mdp-webcop-action-${ key }`;
        $actionBox.className = 'mdp-webcop-action-box mdp-webcop-palette-box';

        const $actionBoxContainer = document.createElement( 'div' );
        $actionBoxContainer.className = 'mdp-webcop-action-box-content';

        const $actionBoxTitle = document.createElement( 'div' );
        $actionBoxTitle.className = 'mdp-webcop-title';
        ...
        $colorBox.className = 'mdp-webcop-color-box';
        ...
        colors.forEach( color => {
            ...
            $color.className = `mdp-webcop-color${ colorClass }`
            $color.tabIndex = 0;
    ...
    static $usefulLinks( key ) {
        ...
        const $actionBox = document.createElement( 'div' );
        $actionBox.id = `mdp-webcop-action-${ key }`;
        $actionBox.className = 'mdp-webcop-action-box mdp-webcop-useful-links-box';

        $actionBox.innerHTML = `
        <div class="mdp-webcop-action-box-content">
            <label for="mdp-webcop-useful-links" class="mdp-webcop-title">${ i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t( key ) }</label>
            <div class="mdp-webcop-select-box">
                <select id="mdp-webcop-useful-links" aria-label="Useful Links">
    ...
    static $switch( key, title, short, description ) {
        ...
        const $actionBox = document.createElement( 'div' );
        $actionBox.id = `mdp-webcop-accessibility-${ key }`;
        $actionBox.className = 'mdp-webcop-accessibility-profile-item';
        $actionBox.tabIndex = 0;

        $actionBox.innerHTML = `
        <div class="mdp-webcop-row">
            <div class="mdp-webcop-switch-box">
                <label class="mdp-switch">
                    ${ title }
                    <input type="checkbox" name="mdp-webcop-accessibility-${ key }" value="on" tabindex="-1">
                    <span class="mdp-slider"></span>
                </label>
            </div>
            <div class="mdp-webcop-title-box">
                <div class="mdp-webcop-profile-title">${ title }</div>
                <div class="mdp-webcop-profile-short">${ short }</div>
            </div>
        </div>
        <div class="mdp-webcop-profile-description">${ description }</div>`;
...
class Popup {
    ...
    $commentStart = document.createComment('Start Webcop Accessibility Popup');
    $commentEnd = document.createComment('End Webcop Accessibility Popup');
    ...
    renderPopup( options ) {
        ...
        $popupBox.id = 'mdp-webcop-popup-box';
        $popupBox.classList.add( `mdp-webcop-modal-animation-${ options.popupAnimation }` );
        $popupBox.classList.add( 'mdp-webcop-modal-fixed' );
        if ( options.popupShadow ) {
            $popupBox.classList.add( 'mdp-webcop-modal-shadow' );
        }
        $popupBox.setAttribute( 'aria-hidden', 'true' );
        $popupBox.setAttribute( 'data-nosnippet', '' );

        const $popup = document.createElement( 'div' );
        $popup.id = 'mdp-webcop-popup';
        $popup.setAttribute( 'role','dialog' );
        $popup.setAttribute( 'aria-modal','true' );
        $popup.setAttribute( 'data-start','top' );
        $popup.setAttribute( 'aria-labelledby', 'mdp-webcop-popup-box' );
    ...
    renderOffCanvas( options ) {
        ...
        $sidenav.id = 'mdp-webcop-sidebar';
        $sidenav.classList.add( `mdp-webcop-sidebar-${ options.sidebarAlign }` );
        if ( options.popupShadow ) {
            $sidenav.classList.add( 'mdp-webcop-sidebar-shadow' );
        }
    ...
    $header( options ) {
        ...
        $header.id = 'mdp-webcop-popup-header';

        const $heading = document.createElement( webcopOptions.headingTag );
        ...
        if ( options.closeButton ) {
            ...
            $closeButton.id = 'mdp-webcop-popup-close';
    ...
    $section( options ) {
        ...
        $section.id = 'mdp-webcop-popup-main';
    ...
    $footer( options ) {
        ...
        $footer.id = "mdp-webcop-popup-footer";

        if ( options.resetButton ) {

            const $buttonReset = document.createElement( 'button' );

            $buttonReset.id = 'mdp-webcop-reset-btn';
        ...
        if ( options.hideButton ) {
            ...
            $buttonHide.id = 'mdp-webcop-hide-btn';
        ...
        if ( options.accessibilityStatement ) {
            ...
            $accessibilityStatement.classList.add( 'mdp-webcop-statement' );
            $accessibilityStatement.innerHTML = `<a href="${ options.accessibilityStatementLink }" aria-label="${ i18next__WEBPACK_IMPORTED_MODULE_6__["default"].t( 'accessibility-statement' ) }" id="mdp-webcop-statement-btn" target="_blank" rel="noopener">${ i18next__WEBPACK_IMPORTED_MODULE_6__["default"].t( i18next__WEBPACK_IMPORTED_MODULE_6__["default"].t( 'accessibility-statement' ) ) }</a>`;
    ...
    $statement( options  ) {
        ...
        $inlineAccessibilityStatement.id = 'mdp-webcop-accessibility-statement-box';
        if ( options.accessibilityStatementType === 'iframe' ) { $inlineAccessibilityStatement.className = 'mdp-webcop-accessibility-statement-iframe'; }

        $inlineAccessibilityStatement.innerHTML = `
        <button id="mdp-webcop-close-statement-btn" aria-label="${ i18next__WEBPACK_IMPORTED_MODULE_6__["default"].t( 'close-accessibility-panel' ) }"></button>
        <div class="mdp-webcop-statement-content">
        `;

        // Iframe statement
        if ( options.accessibilityStatementType === 'iframe' ) {

            $inlineAccessibilityStatement.innerHTML += `<iframe src="${ webcopOptions.accessibilityStatementLink }" title="${ i18next__WEBPACK_IMPORTED_MODULE_6__["default"].t( 'accessibility-statement' ) }"></iframe>`
    ...
    renderKeyboard( options ) {
        ...
        $keyboard.id = 'mdp-webcop-keyboard-box';
...
class SectionAccessibilityProfiles {
    ...
    static $section( options ) {
        ...
        $section.id = 'mdp-webcop-accessibility-profiles-box';
...
class SectionEasyOrientation {
    ...
    static $section( options ) {
        ...
        const $section = document.createElement( 'div' );
        $section.id = 'mdp-webcop-easy-orientation-box';
...
class SectionOnlineDictionary {
    ...
    static $section( options ) {
        ...
        const $section = document.createElement( 'div' );
        $section.id = 'mdp-webcop-online-dictionary-box';
        $section.innerHTML = `
        <form id="mdp-webcop-online-dictionary-form" enctype="multipart/form-data" action="#" method="POST">
        <input type="text"
               tabindex="0"
               id="mdp-webcop-online-dictionary-search"
               name="mdp-webcop-online-dictionary-search"
               autocomplete="off"
            ...
            <label for="mdp-webcop-online-dictionary-search">${ i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t( 'start-typing-wikipedia' ) }</label>
        </form>
        <button role="button" tabindex="0" aria-label="Clear search results" id="mdp-webcop-online-dictionary-search-close"></button>
        <div id="mdp-webcop-online-dictionary-search-results-box">
            <ul id="mdp-webcop-online-dictionary-search-results"></ul>
        </div>`;
...
class SectionReadableExperience {
    ...
    static $section( options ) {
        ...
        const $section = document.createElement( 'div' );
        $section.id = 'mdp-webcop-readable-experience-box';
...
class SectionVisuallyPleasingExperience {
    ...
    static $section( options ) {
        ...
        const $section = document.createElement( 'div' );
        $section.id = 'mdp-webcop-visually-pleasing-experience-box';
...
class Typography {
    ...
    static $heading( text = '', tagName = webcopOptions.subHeadingTag ) {

        const $heading = document.createElement( 'div' );
        $heading.classList.add( 'mdp-webcop-subheader' );
 ...
 * Exclusively on https://1.envato.market/webcop-js
 *
 * @encoding        UTF-8
 * @version         1.0
...
window.Webcop = class Webcop {

    /**
     * Webcop init
     * @param options Webcop options
     * @param css Webcop CSS variables
     */
    constructor( options = {}, css = {} ) {
        ...
        /** Exit if mdp-webcop-hide cookie is set */
        if ( window.document.cookie.indexOf( 'mdp-webcop-hide=1' ) > -1 ) { return; }

        /** Add locale */
        const i18nConfig = {
            fallbackLng: 'en',
            supportedLngs: webcopOptions.supportedLanguages,
            backend: {
                backends: [
                ...
                backendOptions: [{
                    loadPath: `${ webcopOptions.path }/locales/{{lng}}/{{lng}}-{{ns}}.json`
                }]
            }

        }
        if ( webcopOptions.locale.length > 0 ) { i18nConfig.lng = _import_defaultOptions__WEBPACK_IMPORTED_MODULE_5__.defaultOptions.locale; }
        i18next__WEBPACK_IMPORTED_MODULE_0__["default"].use(i18next_browser_languagedetector__WEBPACK_IMPORTED_MODULE_1__["default"]).use(i18next_chained_backend__WEBPACK_IMPORTED_MODULE_2__["default"]).init( i18nConfig ).then( r => {
            ...
            new _ui_Button__WEBPACK_IMPORTED_MODULE_6__.Button( webcopOptions );

            /** Render accessibility popup */
            new _ui_Popup__WEBPACK_IMPORTED_MODULE_7__.Popup( webcopOptions );
            ...
            _module_OnlineDictionary__WEBPACK_IMPORTED_MODULE_10__.OnlineDictionary.init( webcopOptions );
            _module_ReadableExperience__WEBPACK_IMPORTED_MODULE_17__.ReadableExperience.init( webcopOptions );
            _module_VisuallyPleasingExperience__WEBPACK_IMPORTED_MODULE_18__.VisuallyPleasingExperience.init( webcopOptions );
            _module_EasyOrientation__WEBPACK_IMPORTED_MODULE_19__.EasyOrientation.init( webcopOptions );

            /** Actions for Footer Button. */
            _action_ActionResetSettings__WEBPACK_IMPORTED_MODULE_15__.ActionResetSettings.init( webcopOptions );
            _action_ActionHideAccessibility__WEBPACK_IMPORTED_MODULE_16__.ActionHideAccessibility.init( webcopOptions );

            /** Initialise Accessibility Statement. */
            _action_ActionAccessibilityStatement__WEBPACK_IMPORTED_MODULE_14__.ActionAccessibilityStatement.init( webcopOptions );
    ...
    mergeOptions( options ) {
        ...
        for ( const [ key, value ] of Object.entries( options ) ) {
            ...
            if ( typeof value !== typeof _import_defaultOptions__WEBPACK_IMPORTED_MODULE_5__.defaultOptions[ key ] ) {
                console.warn( `Webcop: Wrong '${ key }' options type. Expected '${ typeof _import_defaultOptions__WEBPACK_IMPORTED_MODULE_5__.defaultOptions[ key ] }' but given '${ typeof value }'` );
        ...
        /** Merge default options with new options */
        window.webcopOptions = Object.assign( _import_defaultOptions__WEBPACK_IMPORTED_MODULE_5__.defaultOptions, options );
    ...
    isObject( options ) {
        ...
        if ( typeof options !== 'object' ) {
            ...
            console.error( `Webcop: Wrong options type. Expected 'object' but given '${ typeof options }'` );
            return false;
    ...
    closePopup() {
        ...
        const el = document.querySelector( '#mdp-webcop-popup-box' );
    ...
    removeButton() {
        ...
        const el = document.querySelector( '.mdp-webcop-trigger-button-box' );
        if ( el ) {
    ...
    addButton() {
        ...
        if ( ! document.querySelector( '.mdp-webcop-trigger-button-box' ) ) {
